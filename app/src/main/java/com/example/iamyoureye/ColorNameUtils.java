...
public class ColorNameUtils {
    private static ArrayList<ColorName> initColorList() {
        ...
        colorList.add(new ColorName("Dark SeaGreen", 0x8F, 0xBC, 0x8F));
        colorList.add(new ColorName("Dark SlateBlue", 0x48, 0x3D, 0x8B));
        colorList.add(new ColorName("Dark SlateGray", 0x2F, 0x4F, 0x4F));
        ...
        colorList.add(new ColorName("Medium SeaG reen", 0x3C, 0xB3, 0x71));
